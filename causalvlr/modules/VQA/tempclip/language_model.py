...
class Bert(nn.Module):
    ...
    def __init__(self, tokenizer, lan):
        ...
        if lan == 'DistilBERT':
            ...
            config = BertConfig.from_pretrained("/data3/fengzhuoqian/CausalVLR_v3/model_weights/bert-base-uncased/bert-base-uncased", output_hidden_states=True)
            self.bert = BertModel.from_pretrained("/data3/fengzhuoqian/CausalVLR_v3/model_weights/bert-base-uncased/bert-base-uncased", config=config)
        elif lan == 'RoBERTa':
            from transformers import RobertaModel, RobertaConfig
            config = RobertaConfig.from_pretrained("/data3/fengzhuoqian/CausalVLR_v3/model_weights/roberta-base/roberta-base", output_hidden_states=True)
            self.bert = RobertaModel.from_pretrained("/data3/fengzhuoqian/CausalVLR_v3/model_weights/roberta-base/roberta-base", config=config, add_pooling_layer=False)
        elif lan == 'DeBERTa':
