...
import torch
import math
from causalvlr.modules.VQA.tempclip.language_model import Bert, LanModel
import copy
from transformers.modeling_outputs import BaseModelOutput
from transformers import BertConfig
from transformers import RobertaConfig
from transformers import DebertaConfig
from causalvlr.utils.VQA import get_mask
import torch.nn.functional as F

import h5py
import os.path as osp
from causalvlr.modules.VQA.tempclip.transformer import Transformer, Embeddings
...
class TempCLIP(nn.Module):
    def __init__(
        ...
        if cfgs["model"]["lan"] == 'BERT':
            ...
            pt_config_name = '/data3/fengzhuoqian/CausalVLR_v3/model_weights/roberta-base/roberta-base'
